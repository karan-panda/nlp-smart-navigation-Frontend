      ...
      >
        <div className="text-center mb-4">
          <div className="icon-gradient mx-auto mb-2 d-flex align-items-center justify-content-center" style={{width: '70px', height: '70px', borderRadius: '15px', background: 'linear-gradient(135deg, #FF6600 0%, #FF9A00 100%)'}}>
            <FaShieldAlt style={{color:'white', fontSize: '2rem'}} />
          </div>
          <h2 className="fw-bold" style={{color: '#333'}}>Activate Booster</h2>
          <p className="text-muted">Enhanced protection for your specific healthcare needs</p>
        </div>
      </motion.div>
      ...
      <Card className="border-0 shadow-sm mb-4" style={{borderRadius: "16px", overflow: "hidden"}}>
        <div className="text-white p-4" style={{ background: 'linear-gradient(135deg, #FF6600 0%, #FF9A00 100%)' }}>
          <div className="d-flex align-items-center mb-2">
            ...
            <h5 className="mb-0 fw-bold">ICICI Lombard's Activate Booster</h5>
          </div>
          ...
          <div className="mt-3">
            <span className="badge bg-white text-dark p-2" style={{borderRadius: "8px"}}>Starting at ₹2,183/year*</span>
          </div>
        </div>
