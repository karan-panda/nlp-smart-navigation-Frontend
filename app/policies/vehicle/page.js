    ...
    return (
      <div style={{ padding: '20px', backgroundColor: '#FFF', color: '#333', minHeight: '100vh', fontFamily: 'Arial, sans-serif' }}>
        ...
        <div style={{ display: 'flex', gap: '10px', marginTop: '10px' }}>
          ...
          <button style={{ padding: '10px 20px', backgroundColor: '#FF6600', color: '#FFF', border: 'none', borderRadius: '20px', fontWeight: 'bold' }} onClick={() => router.push('/policies/vehicle')}>Vehicle</button>
        ...
        <div style={{ textAlign: 'center', marginTop: '50px' }}>
          ...
          <button style={{ padding: '12px 25px', backgroundColor: '#FF6600', color: '#FFF', border: 'none', borderRadius: '8px', fontSize: '16px', cursor: 'pointer' }} onClick={() => router.push('/buy-policy/vehicle')}>Buy policy</button>
        </div>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <button style={{ padding: '12px 25px', backgroundColor: '#FFF', color: '#FF6600', border: '2px solid #FF6600', borderRadius: '8px', fontSize: '16px', cursor: 'pointer' }} onClick={() => router.push('/add-policy/vehicle')}>Add policy</button>
        </div>
